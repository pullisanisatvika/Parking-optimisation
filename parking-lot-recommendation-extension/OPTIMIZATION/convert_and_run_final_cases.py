...
def build_summary_row(
    ...
    objective_context = build_spot_normalization_context(parse_spot_opl_dat(assignments["__raw_text__"]))
    objective = normalized_spot_objective(travel_time, parking_cost, context=objective_context)
