...
def normalize_result_row(row: dict) -> dict:
    ...
    objective_context = build_spot_normalization_context(parse_spot_opl_dat(dat_text))
    objective = safe_float(first_value("objective"), normalized_spot_objective(travel_time_hr, parking_cost, context=objective_context))
